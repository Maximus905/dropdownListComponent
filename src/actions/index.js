...
export const requestData = ({url, dataFieldName, fetchFunction, accessor, filters, sorting, wildcards, selected}) => ({type: REQUEST_DATA, payload: {url, dataFieldName, fetchFunction, accessor, filters, sorting, wildcards, selected}})
